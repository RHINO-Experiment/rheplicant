"""The conjugate family's shared machine: the block, the prior, the sigma.

No runs[].kind is runnable yet -- Tasks 3-5 land those -- so these drive the
helpers directly against a built document, which is exactly the surface the
four executors will call.
"""
