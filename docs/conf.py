...
nitpick_ignore = [
    ("py:class", "BayesMemory"),
    ("py:class", "Convergence test"),
    ("py:class", "Coordinates"),
    ("py:class", "Environment"),
    ("py:class", "FlaggedNoise"),
    ("py:class", "FrozenMapping"),
    ("py:class", "HomoscedasticNoise"),
    ("py:class", "NoiseModel"),
    ("py:class", "_rheplicant_bootstrap.capture.CaptureService"),
    ("py:class", "_rheplicant_bootstrap.types.DestinationDescriptor"),
    ("py:class", "_rheplicant_bootstrap.types.LayerIdentity"),
    ("py:class", "_rheplicant_bootstrap.types.Origin"),
    ("py:class", "_rheplicant_bootstrap.types.OriginLookup"),
    ("py:class", "_rheplicant_bootstrap.types.TraceSink"),
    ("py:class", "equinox._module._module.Module"),
    ("py:class", "equinox.nn._mlp.MLP"),
    ("py:class", "jaxlib._jax.pytree.PyTreeDef"),
    ("py:class", "rheplicant.config.context.T"),
    ("py:class", "rheplicant.config.dimensions.DimensionEnvironment"),
    ("py:class", "rheplicant.config.dimensions.DimensionSignature"),
    ("py:class", "rheplicant.config.dimensions.DimensionSpec"),
    ("py:class", "rheplicant.config.resolution_audit.ResolutionAudit"),
    ("py:class", "rheplicant.radio.filters.SkySpaceFilter"),
    ("py:class", "rheplicant.radio.instrument.gain.\nGainOperator"),
    ("py:func", "_refuse_a_time_axis_the_stored_dtype_cannot_carry"),
    ("py:func", "_reject_a_foreign_stack"),
    ("py:func", "_tightest_direction"),
    ("py:func", "gcr_sample"),
    ...
    ("py:func", "linear_operator(..., check=False)"),
    ("py:func", "rheplicant.core.fold._check_ordering"),
    ("py:func", "rheplicant.core.fold._check_slot_kinds"),
    ("py:func", "rheplicant.core.graph.\nassemble"),
    ("py:func", "rheplicant.inference.linear.\ncheck_linearity"),
    ("py:func", "rheplicant.inference.uncertainty.\nfisher_information"),
    ("py:func", "wiener_solve"),
    ("py:meth", "BeamSpillOperator.from_projector"),
    ("py:meth", "IdentifiabilityReport.\ndirection"),
    ("py:meth", "rheplicant.inference.parameters.ParameterSpace.__check_init__"),
