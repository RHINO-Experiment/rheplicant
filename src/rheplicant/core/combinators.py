...
:class:`~rheplicant.core.pipeline.Pipeline` composes operators *sequentially*;
...
from rheplicant.core.pipeline import resolve_names, validate_operators
...
class SumOperator(AbstractOperator):
    ...
    def replace_branch(self, index: int | str, operator: AbstractOperator) -> "SumOperator":
        ...
        Parity with :meth:`~rheplicant.core.pipeline.Pipeline.replace_stage`.
        """
