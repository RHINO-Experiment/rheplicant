...
engine via ``replicant.inference.build_forward_fn``.
"""
...
from replicant.radio.sky.model import AbstractSkyModel
...
class SkySourceOperator(AbstractOperator):
    ...
    Attributes:
        sky_model: what the sky is — :class:`~replicant.radio.sky.model.AbstractSkyModel`.
        projector: how it is seen — :class:`~replicant.radio.sky.projection.AbstractSkyProjector`.
    """
