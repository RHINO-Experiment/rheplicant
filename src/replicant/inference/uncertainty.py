...
- **Monte Carlo pushforward** — :func:`push_forward` vmaps ``forward`` over
  ...
  :func:`~replicant.inference.numpyro_bridge.predict_from_samples`), giving the
...
:class:`~replicant.inference.calibrate.GradientCalibrator`, take
...
:func:`~replicant.inference.forward.build_forward_fn` — uncertainty tooling
...
def fisher_information(
    ...
    :class:`~replicant.inference.likelihood.MaskedGaussianLikelihood`.
